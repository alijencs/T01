...
public class GreeterServerExample {
    public static void main(String[] args) {
        try {
            ServerListener server = new ServerListener("GreeterServer", 6321, GreeterServerProtocol::new);
            server.start();
            System.out.println("\nThe server is listening on port 431.\nPlease open telnet and connect to " +
                    "this machine on port 431. You may open multiple simultaneous connections.");
